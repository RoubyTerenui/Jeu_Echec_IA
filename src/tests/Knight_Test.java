...
class Knight_Test {
	...
	void test() {
		...
		List<int[]>testPoss=environment.getChessBoard()[0][1].getActualPieces().possibleMoves(environment.getChessBoard());
		assertEquals(testPoss.size(), 2);
		environment.getChessBoard()[3][4].setActualPieces(new Knight(0,0,false));
		testPoss.clear();
